...
public class Application {
    public static void main(String[] args) {
        ...
        aggregator.addHasArea(new Circle(5));
        aggregator.addHasArea(new Circle(2));
        aggregator.addHasArea(new Ellipse(2,3));
        aggregator.addHasArea(new Rectangle(10,5));
        aggregator.addHasArea(new Triangle(10,2));
        aggregator.addHasArea(new House(100));
